...
const APP_NAME = "Quest of the Harmony Knight";
  ...
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#0b0e12" },
      {
        name: "description",
        content:
          "A neuro-inclusive music theory quest. Short sessions, figurenotes scaffolding, and a duel with the Discord Sentinel.",
      },
    ],
    links: [
