...
const workspaceDocs = {
  skip: [".grok/skills/og/SKILL.md", "AGENTS.md"].every((rel) =>
    existsSync(join(TEMPLATE_ROOT, rel)),
  )
    ? false
    : "Workspace authoring instructions are not distributed with the standalone app",
};
...
test("the sections that own the brand-task prohibition never affirm a wait", workspaceDocs, () => {
...
test("SKILL.md tells the pass to self-check with the flag this CLI accepts", workspaceDocs, () => {
